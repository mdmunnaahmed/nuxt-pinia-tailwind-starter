  ...
  <div id="main-wrapper" class="main-wrapper">
    ...
    <section class="banner banner-style-1">
          ...
          <div class="col-lg-6">
            ...
            >
              ...
              <span class="subtitle"
                ...
                based on their behaviors.</span
              >
              <a href="contact.html" class="axil-btn btn-fill-primary btn-large"
                >Get Started</a
              >
            </div>
          </div>
          <div class="col-lg-6">
            <div class="banner-thumbnail">
              <div
                ...
                data-sal-delay="300"
              >
                <img src="/media/banner/window.png" alt="Laptop" />
              </div>
              <div
                class="large-thumb-2"
                data-sal="slide-left"
                ...
                data-sal-delay="800"
              >
                <img src="/media/banner/laptop-poses.png" alt="Laptop" />
              </div>
              <ul class="list-unstyled shape-group">
                <li
                  ...
                  data-sal-delay="800"
                >
                  <img src="/media/banner/chat-group.png" alt="chat" />
                </li>
              </ul>
            </div>
          </div>
      ...
      <ul class="list-unstyled shape-group-21">
        <li
          ...
          data-sal-delay="100"
        >
          <img src="/media/others/bubble-39.png" alt="Bubble" />
        </li>
        <li
          class="shape shape-2"
          data-sal="zoom-in"
          ...
          data-sal-delay="500"
        >
          <img src="/media/others/bubble-38.png" alt="Bubble" />
        </li>
        <li
          class="shape shape-3"
          data-sal="slide-left"
        ...
        <li
          ...
          data-sal-delay="700"
        >
          <img src="/media/others/bubble-40.png" alt="Bubble" />
        </li>
        <li
          class="shape shape-7"
          data-sal="slide-left"
          ...
          data-sal-delay="700"
        >
          <img src="/media/others/bubble-41.png" alt="Bubble" />
        </li>
      </ul>
    </section>
    ...
    <section class="section section-padding-2 bg-color-dark">
      ...
      <ul class="list-unstyled shape-group-10">
        <li class="shape shape-1">
          <img src="/media/others/line-9.png" alt="Circle" />
        </li>
        <li class="shape shape-2">
          <img src="/media/others/bubble-42.png" alt="Circle" />
        </li>
        <li class="shape shape-3">
          <img src="/media/others/bubble-43.png" alt="Circle" />
        </li>
      </ul>
    </section>
    <!--=====================================-->
    ...
    <section class="section section-padding-equal case-study-featured-area">
      <div class="container">
        <div class="row">
          ...
          >
            <div
              class="slick-slider slick-dot-nav featured-content"
          ...
          >
            <div
              class="slick-slider slick-dot-nav featured-thumbnail"
            ...
            >
              <div class="slick-slide">
                <div class="case-study-featured-thumb">
                  <img
                    src="/media/others/case-study-4.png"
                    alt="travel"
                  />
                </div>
              </div>
              <div class="slick-slide">
                <div class="case-study-featured-thumb">
                  <img
                    src="/media/others/case-study-5.png"
                    alt="travel"
                  />
                </div>
              </div>
              <div class="slick-slide">
                <div class="case-study-featured-thumb">
                  <img
                    src="/media/others/case-study-6.png"
                    alt="travel"
                  />
                </div>
              </div>
    ...
    <section class="section section-padding-equal bg-color-light">
        ...
        <div class="row align-items-center">
          ...
          >
            <div class="contact-form-box">
              ...
              <form
                method="POST"
                action="https://new.axilthemes.com/demo/template/abstrak/mail.php"
      ...
      <ul class="shape-group-6 list-unstyled">
        <li class="shape shape-1">
          <img src="/media/others/bubble-7.png" alt="Bubble" />
        </li>
        <li class="shape shape-2">
          <img src="/media/others/line-4.png" alt="line" />
        </li>
        <li class="shape shape-3">
          <img src="/media/others/line-5.png" alt="line" />
        </li>
      </ul>
    </section>
    <!--=====================================-->
    ...
    <section class="section section-padding-2">
              ...
              <div class="project-grid">
                <div class="thumbnail">
                  <a href="single-portfolio.html">
                    <img
                      src="/media/project/project-1.png"
                      alt="project"
                    />
                  </a>
                </div>
            ...
            <div class="col-md-6 project mobile">
              <div class="project-grid">
                <div class="thumbnail">
                  <a href="single-portfolio.html">
                    <img
                      src="/media/project/project-2.png"
                      alt="project"
                    />
                  </a>
                </div>
            ...
            <div class="col-md-6 project branding">
              <div class="project-grid">
                <div class="thumbnail">
                  <a href="single-portfolio.html">
                    <img
                      src="/media/project/project-3.png"
                      alt="project"
                    />
                  </a>
                </div>
            ...
            <div class="col-md-6 project mobile">
              <div class="project-grid">
                <div class="thumbnail">
                  <a href="single-portfolio.html">
                    <img
                      src="/media/project/project-4.png"
                      alt="project"
                    />
                  </a>
                </div>
            ...
            <div class="col-md-6 project branding">
              <div class="project-grid">
                <div class="thumbnail">
                  <a href="single-portfolio.html">
                    <img
                      src="/media/project/project-5.png"
                      alt="project"
                    />
                  </a>
                </div>
            ...
            <div class="col-md-6 project mobile">
              <div class="project-grid">
                <div class="thumbnail">
                  <a href="single-portfolio.html">
                    <img
                      src="/media/project/project-6.png"
                      alt="project"
                    />
                  </a>
                </div>
      ...
      <ul class="shape-group-7 list-unstyled">
        <li class="shape shape-1">
          <img src="/media/others/circle-2.png" alt="circle" />
        </li>
        <li class="shape shape-2">
          <img src="/media/others/bubble-2.png" alt="Line" />
        </li>
        <li class="shape shape-3">
          <img src="/media/others/bubble-1.png" alt="Line" />
        </li>
      </ul>
    </section>
    <!--=====================================-->
    ...
    <section class="section section-padding bg-color-dark">
        ...
        <div class="row">
          ...
          >
            <div class="counterup-progress active">
              <div class="icon">
                <img src="/media/icon/icon-7.png" alt="Apple" />
              </div>
          ...
          >
            <div class="counterup-progress">
              <div class="icon">
                <img src="/media/icon/icon-8.png" alt="Apple" />
              </div>
              <div class="count-number h2">
          ...
          >
            <div class="counterup-progress">
              <div class="icon">
                <img src="/media/icon/icon-9.png" alt="Apple" />
              </div>
              <div class="count-number h2">
          ...
          >
            <div class="counterup-progress">
              <div class="icon">
                <img src="/media/icon/apple.png" alt="Apple" />
              </div>
              <div class="count-number h2">
      ...
      <ul class="list-unstyled shape-group-10">
        <!-- <li class="shape shape-1"><img src="/media/others/line-9.png" alt="Circle"></li> -->
        <li class="shape shape-2">
          <img src="/media/others/bubble-42.png" alt="Circle" />
        </li>
        <li class="shape shape-3">
    ...
    <section class="section section-padding">
        ...
        <div class="row">
          ...
          >
            <div class="testimonial-grid active">
              <span class="social-media"
                ><img src="/media/icon/yelp-2.png" alt="Yelp"
              /></span>
              <p>
                “ Donec metus lorem, vulputate at sapien sit amet, auctor
              ...
              <div class="author-info">
                <div class="thumb">
                  <img
                    src="/media/testimonial/testimonial-1.png"
                    alt="Google Review"
                  />
                </div>
                <div class="content">
          ...
          >
            <div class="testimonial-grid">
              <span class="social-media"
                ><img src="/media/icon/google-2.png" alt="google"
              /></span>
              <p>
                “ Donec metus lorem, vulputate at sapien sit amet, auctor
                iaculis lorem. In vel hendrerit nisi. Vestibulum eget risus
              ...
              <div class="author-info">
                <div class="thumb">
                  <img
                    src="/media/testimonial/testimonial-2.png"
                    alt="Google Review"
                  />
                </div>
                <div class="content">
          ...
          >
            <div class="testimonial-grid">
              <span class="social-media"
                ><img src="/media/icon/fb-2.png" alt="Facebook"
              /></span>
              <p>
                “ Donec metus lorem, vulputate at sapien sit amet, auctor
                iaculis lorem. In vel hendrerit nisi. Vestibulum eget risus
              ...
              <div class="author-info">
                <div class="thumb">
                  <img
                    src="/media/testimonial/testimonial-3.png"
                    alt="Google Review"
                  />
                </div>
                <div class="content">
      ...
      <ul class="shape-group-4 list-unstyled">
        <li class="shape-1">
          <img src="/media/others/bubble-1.png" alt="Bubble" />
        </li>
      </ul>
    </section>
    <!--=====================================-->
    ...
    <section class="section bg-color-light section-padding">
      <div class="container">
        ...
        <div class="pricing-billing-duration">
          <ul>
            <li class="nav-item">
              <button class="nav-link" id="yearly-plan-btn" type="button">
                Billed yearly
              </button>
            </li>
            <li class="nav-item">
            ...
            <div class="pricing-table active">
              <div class="pricing-header">
                ...
                <div class="pricing-btn">
                  <a href="#" class="axil-btn btn-large btn-borderd"
                    >Get Started Today</a
                  >
                </div>
              </div>
      ...
      <ul class="shape-group-3 list-unstyled">
        <li class="shape shape-1">
          <img src="/media/others/line-1.png" alt="shape" />
        </li>
        <li class="shape shape-2">
          <img src="/media/others/bubble-4.png" alt="shape" />
        </li>
      </ul>
    </section>
    <!--=====================================-->
    ...
    <section class="section section-padding-equal">
            ...
            <div class="blog-list active">
              <div class="post-thumbnail">
                <a href="single-blog-2.html"
                  ><img src="/media/blog/blog-1.png" alt="Blog Post"
                /></a>
              </div>
              <div class="post-content">
                <h5 class="title">
                  <a href="single-blog-2.html"
                    >How To Use a Remarketing Strategy To Get More</a
                  >
                </h5>
                <p>
                ...
                <a href="single-blog-2.html" class="more-btn"
                  >Learn more<i class="far fa-angle-right"></i
                ></a>
              </div>
            </div>
          </div>
            ...
            <div class="blog-list border-start">
              <div class="post-thumbnail">
                <a href="single-blog-3.html"
                  ><img src="/media/blog/blog-2.png" alt="Blog Post"
                /></a>
              </div>
              <div class="post-content">
                <h5 class="title">
                  <a href="single-blog-3.html"
                    >SEO Statistics You Should Know in 2021</a
                  >
                </h5>
                <p>
                ...
                <a href="single-blog-3.html" class="more-btn"
                  >Learn more<i class="far fa-angle-right"></i
                ></a>
              </div>
            </div>
      ...
      <ul class="shape-group-1 list-unstyled">
        ...
        <li class="shape shape-2">
          <img src="/media/others/line-1.png" alt="bubble" />
        </li>
        <li class="shape shape-3">
          <img src="/media/others/line-2.png" alt="bubble" />
        </li>
        <li class="shape shape-4">
          <img src="/media/others/bubble-2.png" alt="bubble" />
        </li>
      </ul>
    </section>
    <!--=====================================-->
    ...
    <section class="section call-to-action-area">
      <div class="container">
        <div class="call-to-action">
          <div class="section-heading heading-light">
            ...
            <a href="contact.html" class="axil-btn btn-large btn-fill-white"
              >Estimate Project</a
            >
          </div>
          <div class="thumbnail">
            ...
            >
              <img
                class="paralax-image"
                src="/media/others/chat-group.png"
                alt="Chat"
              />
            </div>
            <ul class="list-unstyled small-thumb">
              ...
              >
                <img
                  class="paralax-image"
                  src="/media/others/laptop-poses.png"
                  alt="Laptop"
                />
              </li>
              <li
      ...
      <ul class="list-unstyled shape-group-9">
        <li class="shape shape-1">
          <img src="/media/others/bubble-12.png" alt="Comments" />
        </li>
        <li class="shape shape-2">
          <img src="/media/others/bubble-16.png" alt="Comments" />
        </li>
        <li class="shape shape-3">
          <img src="/media/others/bubble-13.png" alt="Comments" />
        </li>
        <li class="shape shape-4">
          <img src="/media/others/bubble-14.png" alt="Comments" />
        </li>
        <li class="shape shape-5">
          <img src="/media/others/bubble-16.png" alt="Comments" />
        </li>
        <li class="shape shape-6">
          <img src="/media/others/bubble-15.png" alt="Comments" />
        </li>
...
const fetchOrders = async () => {
  try {
    const { data: order, error } = await supabase.from("users").insert({
      name: "manna",
    });
    if (error) {
